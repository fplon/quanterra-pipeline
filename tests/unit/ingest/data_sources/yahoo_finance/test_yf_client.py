...
def client(mock_session: MagicMock) -> YahooFinanceClient:
    ...
    with patch("src.ingest.data_sources.yahoo_finance.client.Session", return_value=mock_session):
...
class TestYahooFinanceClient:
    ...
    @patch("src.ingest.data_sources.yahoo_finance.client.yf.Tickers")
    ...
    @patch("src.ingest.data_sources.yahoo_finance.client.yf.download")
