...
class BaseFlowSettings(BaseModel):
    bucket_name: str


T = TypeVar("T", bound=BaseFlowSettings)
...
class OANDAFlowSettings(BaseFlowSettings):
    instruments: list[str]
...
class YahooFinanceFlowSettings(BaseFlowSettings):
    tickers: list[str]
